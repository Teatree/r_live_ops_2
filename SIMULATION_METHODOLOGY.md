...
> **⚠ HARDCODED OPT-IN — Kite Festival = 0.35 (D23, 2026-09-01).** `PACK_PARTICIPATION` in
...
**Per-source rows show zeros deliberately.** A zero is a finding — Kite at its D23 0.35 assumed
