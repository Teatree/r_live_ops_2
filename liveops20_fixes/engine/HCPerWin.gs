/************************************************************************************************
 * HCPerWin.gs — HC earned / spent per LEVEL WIN, per segment (21-day A/B window estimate).
 * ---------------------------------------------------------------------------------------------
 ...
 *     with p(active) = weekday_active_rate / weekend_active_rate by the Monday-start weekend
...
// 21-day window, day 1 = Monday 2026-07-27. Declared here as well as in EcoGainsSim_v4.gs
// (SIM_DAYS / SIM_DAY_ONE_DOW) because Apps Script loads files alphabetically and a load-time
// read of another file's var is undefined. harness/_mock_identity.js gates that they match —
// change them together.
var HCW_DAYS = 21;
var HCW_DAY_ONE_DOW = 1;          // 1 = Monday .. 7 = Sunday
