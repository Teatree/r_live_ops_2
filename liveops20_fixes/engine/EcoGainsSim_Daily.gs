 ...
 *               (Team Event / Team Race / Flock Flurry LEFT this family 2026-08-17, synced from
 *               engine/EcoGainsSim_Daily.gs — they are placed on their calendar lanes; see
 *               DAILY_LASTDAY. Window totals unchanged, only the per-day distribution.)
...
// Team Event / Team Race / Flock Flurry sit here (not in the flat family) so their window totals
// land on the days their events actually run. In the collections engine this happened for the pack
// rewards (D19, rank rewards granted at instance END); the placement is right for their carried
// resources too, and keeping both engines identical here means the two sims' daily views agree.
...
var DAILY_CAL_LABEL = {
  ...
  'Team Event':'Team Event', 'Team Race':'Team Race', 'Flock Flurry':'Flock Flurry'
};
